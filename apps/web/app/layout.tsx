...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <head>
        <script defer data-domain="calendarmap.app" src="https://plausible.io/js/script.file-downloads.hash.outbound-links.pageview-props.revenue.tagged-events.js"></script>
